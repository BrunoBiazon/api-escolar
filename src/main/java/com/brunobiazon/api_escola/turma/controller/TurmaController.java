...
public class TurmaController {
    ...
    @PostMapping
    @Transactional
    public ResponseEntity<DadosListagemTurma> cadastrar(@RequestBody @Valid DadosCadastroTurma dados,
    ...
    @GetMapping
    public ResponseEntity<List<DadosListagemTurma>> listar() {
        var turma = repository.findAll().stream().map(DadosListagemTurma::new).toList();
    ...
    @PutMapping
    @Transactional
    public ResponseEntity<DadosListagemTurma> atualizar(@RequestBody @Valid DadosAtualizarTurma dados) {
        ...
        return ResponseEntity.ok(new DadosListagemTurma(turma));
    }
